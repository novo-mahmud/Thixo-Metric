# ==========================================
# Thixo-Metric Web App (Final Working Version)
# ==========================================
...
# We define 'soil_model' ONCE at global scope.
...
with st.sidebar:
    ...
    if uploaded_file:
        try:
            ...
            # Directly update the global model instance.
            # NO 'global' keyword needed here because it's already global at the top.
            global soil_model 
...
if gen_report_btn:
    with st.spinner("Generating Technical Report..."):
        ...
        plt.savefig(img_buffer, format='png') # Resave the plot
