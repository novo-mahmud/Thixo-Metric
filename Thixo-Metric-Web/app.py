# ==========================================
# Thixo-Metric Web App (Final Scope Fix)
# ==========================================
...
# ==========================================
# IMPORTANT: Declare 'soil_model' as global BEFORE initializing
# This prevents the "assigned to before global declaration" error.
global soil_model

# Initialize model only if session data exists (Safety check for first run)
if 'df_soil' in st.session_state:
...
if run_btn:
    with st.spinner("Analyzing... Please wait."):
        # Ensure global model is updated with latest session data
        global soil_model
